          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <p class="text-base text-body-color">
                ...
                we have many different personalities in the team.
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="relative overflow-hidden rounded-lg">
                ...
                <div class="absolute bottom-5 left-0 w-full text-center">
                  ...
                  >
                    ...
                    <p class="text-sm text-body-color">بتدخل تفرفشنا وتمشي تانى</p>
                    <div>
              ...
              <div class="relative overflow-hidden rounded-lg">
                ...
                <div class="absolute bottom-5 left-0 w-full text-center">
                  ...
                  >
                    ...
                    <p class="text-sm text-body-color"> اللى مش بيعجبها حاجه </p>
                    <div>
                      <span class="absolute left-0 bottom-0">
                        <svg
                          width="61"
              ...
              <div class="relative overflow-hidden rounded-lg">
                ...
                <div class="absolute bottom-5 left-0 w-full text-center">
                  ...
                  >
                    ...
                    <p class="text-sm text-body-color">اللى مش عايشة معانا فى الدنيا</p>
                    <div>
                      <span class="absolute left-0 bottom-0">
                        <svg
                          width="61"
              ...
              <div class="relative overflow-hidden rounded-lg">
                ...
                <div class="absolute bottom-5 left-0 w-full text-center">
                  ...
                  >
                    ...
                    <p class="text-sm text-body-color">اللى بتدخلنا فى المناسبات</p>
                    <div>
                      <span class="absolute left-0 bottom-0">
                        <svg
                          width="61"
