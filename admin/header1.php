                        ...
                        <nav class="navbar navbar-expand-lg ">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar " id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto ">
                                    ...
                                    <li class="nav-item ">
                                        <a href="test.php" class="active" aria-label="Toggle navigation">MEMBERS</a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="../shopping/index.php" class="active" aria-label="Toggle navigation">CATEGORIES</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index.html" class="active" aria-label="Toggle navigation"></a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="../shopping/products.php" class="active" aria-label="Toggle navigation">EDIT</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-2">
                                            ...
                                            <li class="nav-item"><a href="forms.php">Login</a></li>
